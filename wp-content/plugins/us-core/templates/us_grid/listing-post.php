...
<article <?php post_class( $post_classes ) ?> data-id="<?php the_ID() ?>">
	<div class="w-grid-item-h"<?= $inline_css ?>>
		...
		<?php if( $attachment = $attachments->get_single( $my_index ) ) : ?>
			<a class="w-btn us-btn-style_5 us_custom_85abdf68 target-button icon_atleft" href="<?php echo $attachments->url( $my_index ); ?>" alt="<?php echo $attachments->field( 'title', $my_index ); ?>">Download</a>
		<?php endif; ?>
		<?php endif; ?> 
